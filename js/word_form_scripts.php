<script>
	function pofspeech_changed() {
		if($("#partofspeech_input").val() != 'noun' && $("#partofspeech_input").val() != 'number' && $("#partofspeech_input").val() != 'verb') {
			$("#infinitive_input, #gender_input, #plural_input, #exception_id_input, #pl_translation_input, #ms_input, #fs_input, #mp_input, #fp_input, #form_id_input").parent().hide()
			$("#gender_input").val('m');
			$("#plural_input").val('');
			...
			$("#infinitive_input, #exception_id_input, #plural_input, #pl_translation_input, #ms_input, #fs_input, #mp_input, #fp_input").parent().hide()
			...
			$("#infinitive_input, #ms_input, #fs_input, #mp_input, #fp_input, #form_id_input").parent().show();
			...
			$("#infinitive_input, #ms_input, #fs_input, #mp_input, #fp_input, #form_id_input").val('').parent().hide();
			$("#word_input").attr('required', '');
		}
	}
	pofspeech_changed();
