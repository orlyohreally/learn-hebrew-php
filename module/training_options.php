<div onclick="start_training('multichoice', 'ru-he')" class="card trainig-option text-white bg-primary mb-3">
  <div class="card-header bg-primary">Поиск перевода ru-he</div>
  <div class="card-body p-2">
    <p class="card-text">Выбор перевода из списка</p>
  </div>
</div>
<div onclick="start_training('multichoice', 'he-ru')" class="card trainig-option text-white bg-info mb-3">
  <div class="card-header bg-info">Поиск перевода he-ru</div>
  <div class="card-body p-2">
    <p class="card-text">Выбор перевода из списка</p>
  </div>
</div>
<div onclick="start_training('spelling', 'ru-he')" class="card trainig-option text-white bg-primary mb-3">
  <div class="card-header bg-primary">Перевод ru-he</div>
  <div class="card-body p-2">
    <p class="card-text">Ввод перевода с клавиатуры</p>
  </div>
</div>
<div onclick="start_training('spelling', 'he-ru')" class="card trainig-option text-white bg-info mb-3">
