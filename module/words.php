	...
	<div class="row">
		<div class="col-12 col-md-3 mt-2 mb-2">
			<select class="form-control" id="part_of_speech_select">
				<option <?php if($partofspeech == '') echo 'selected';?> value="">Все слова</option>
		...
		<div class="col-12 col-md-3 mt-2 mb-2">
			<select class="form-control" id = "topic_select">
				<option  <?php if($topic == '') echo 'selected';?> value="">Любая тема</option>
				<?php
		...
		<div class="col-12 mt-4 mb-2">
			<table id="list" class="table table-striped table-bordered display nowrap" style="width:100%">
				...
				<tbody>
				<?php
					$sql = 'select w.id id, word, comment, translation, gender, plural, plural_translation, part_of_speech from word w left join topic t on t.id = w.topic_id where ("'.$partofspeech.'" = "" or part_of_speech = "'.$partofspeech.'") and ("'.$topic.'" = "" or t.slug = "'.$topic.'") order by word, translation';
